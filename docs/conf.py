...
about = {}
with open(os.path.join(base_dir, 'pipelines_template', '__about__.py')) as f:
    exec(f.read(), about)
...
autoprocess_process_dir = os.path.join(base_dir, 'pipelines_template', 'processes')

# Base of the url to process source code:
autoprocess_source_base_url = 'https://github.com/genialis/pipelines-template/blob/master/pipelines_template/processes/'
...
htmlhelp_basename = 'Pipelinestemplatedoc'

# Configuration for intersphinx
intersphinx_mapping = {
    'python': ('https://docs.python.org/3', None),
    'resolwe': ('https://resolwe.readthedocs.io/en/latest', None),
    'resolwe_bio': ('https://resolwe-bio.readthedocs.io/en/latest', None),
}
